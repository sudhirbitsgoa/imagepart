        ...
        <script>
            ...
            function onStopRecording() {
                audioRecorder.getDataURL(function(audioDataURL) {
                    ...
                    console.log("this is the audio blob ",audio);
                    ...
                    if(!isRecordOnlyAudio) {
                        videoRecorder.getDataURL(function(videoDataURL) {
                            ...
                            console.log("this is the video blob",video);
            ...
            btnStartRecording.onclick = function() {
                ...
                captureUserMedia(function(stream) {
                    mediaStream = stream;
                    /**
                    * How webrtc works i dont know but seeing this
                    * This function is called only once and after that a persistent connection is established
                    * and traffic flows
                    **/
                    console.log('this stream will upload the file',stream);
